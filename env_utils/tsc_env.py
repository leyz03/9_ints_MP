...
class TSCEnvironment(gym.Env):
    def __init__(
        ...
        self.agent_tls_ids = agent_tls_ids
        self.non_agent_tls_ids = non_agent_tls_ids
        self.tls_ids = sorted(agent_tls_ids + non_agent_tls_ids) # 需要控制的路口 ID
        self.tsc_env = TshubEnvironment(
            ...
            tls_ids=sorted(agent_tls_ids + non_agent_tls_ids),
